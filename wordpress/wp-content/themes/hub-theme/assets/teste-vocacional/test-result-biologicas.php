<section id="result-section" class="col-md-12">
  <div class="container">
    ...
    <span class="course-title-label"> CIÊNCIAS BIOLÓGICAS </span>
...
<section id="cursos-lista" class="col-md-12 lista-cursos-result ">
  <div class="row">
    <div class="column-cursos col-md-4">
      ...
      <ul>
        <li><a href="" target="_blank">BIOMEDICINA</a></li>
        <li><a href="" target="_blank">CIÊNCIAS BIOLÓGICAS (Bacharelado)</a></li>
        <li><a href="" target="_blank">CIÊNCIAS BIOLÓGICAS (Licenciatura)</a></li>
        <li><a href="" target="_blank">EDUCAÇÃO FÍSICA (Bacharelado)</a></li>
        <li><a href="" target="_blank">EDUCAÇÃO FÍSICA (Licenciatura)</a></li>
        <li><a href="" target="_blank">ENFERMAGEM</a></li>
        <li><a href="" target="_blank">ESTÉTICA E COSMÉTICA</a></li>
        <li><a href="" target="_blank">FARMÁCIA</a></li>
        <li><a href="" target="_blank">FISIOTERAPIA</a></li>
        <li><a href="" target="_blank">MEDICINA VETERINÁRIA</a></li>
        <li><a href="" target="_blank">NUTRIÇÃO</a></li>
        <li><a href="" target="_blank">ODONTOLOGIA</a></li>
        <li><a href="" target="_blank">PSICOLOGIA</a></li>
      </ul>
    </div>
  </div>
